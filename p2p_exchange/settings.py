"""
Django settings for p2p_exchange project.
...
# The custom user model that replaces Django's default User.
# This MUST be set before the very first migration is run.
...
ROOT_URLCONF = 'p2p_exchange.urls'
...
WSGI_APPLICATION = 'p2p_exchange.wsgi.application'
...
# Media files (item photos uploaded by users)
MEDIA_URL = '/media/'
